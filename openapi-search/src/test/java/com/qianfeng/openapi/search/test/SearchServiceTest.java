...
import com.qianfeng.openapi.search.model.GatewayLog;
import com.qianfeng.openapi.search.service.SearchService;
import com.qianfeng.openapi.search.service.impl.SearchServiceImpl;
...
public class SearchServiceTest {
    ...
    public void testAddData(){
       for(int i=0; i < 10; i++){
           ...
           gatewayLog.setApiName("taobao.search");
           gatewayLog.setAppkey("appkey2");
           gatewayLog.setCreateTime(new Date());
           gatewayLog.setErrorCode("0000");
           gatewayLog.setPlatformRepTime(i+10000);
...
//        searchService.statAvg(1458332215006l,1658332215119l);
    ...
    @Test
    public void testStatCountAndAvg() throws IOException {
        searchService.statCountAndAvg(0,System.currentTimeMillis());
    }
    ...
    public void testSearch() throws IOException, InterruptedException {
       ...
       // searchPara.put("appkey","appkey1");
        searchPara.put("apiName","taobao.search");
